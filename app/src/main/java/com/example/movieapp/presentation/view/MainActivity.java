...
public class MainActivity extends AppCompatActivity implements MoviesAdapter.ClickHandlers {
    ...
    private void setupRecyclerAdapter(){
        viewModel.getMovieList().observe(this, movieList -> {
            ...
            Log.i(this.getClass().getSimpleName(), "Movie count: " + String.valueOf(movieList.size()));
